...
• Local HuggingFace embeddings — no API quota, no rate limits
• LangChain prompt chain with structured output parsing
...
• DeepSeek V3.2 via OpenRouter (generation)
